<?php
/**
 * Proxy autenticado para archivos bajo PLANOS_SNAPSHOTS_FILESYSTEM_ROOT.
...
require_once dirname(__FILE__) . DIRECTORY_SEPARATOR . 'scripts' . DIRECTORY_SEPARATOR . 'plano_snapshot_archivo_local.php';
...
$fileReal = plano_snapshot_archivo_local_path_validated($archivoParam);
if ($fileReal === false) {
