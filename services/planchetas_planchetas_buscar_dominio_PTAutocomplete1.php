<?php
//Include Common Files @1-C8B4A36F
define("RelativePath", "..");
define("PathToCurrentPage", "/services/");
define("FileName", "planchetas_planchetas_buscar_dominio_PTAutocomplete1.php");
...
//Show Method @2-F3FC6572
    function Show()
    {
        ...
        $this->DataSource->Parameters["postdominio"] = CCGetFromPost("dominio", NULL);
...
//Prepare Method @2-AE85E6A1
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->wp = new clsSQLParameters($this->ErrorBlock);
        $this->wp->AddParameter("1", "postdominio", ccsText, "", "", $this->Parameters["postdominio"], "", false);
...
//Open Method @2-80CC6B4D
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "SELECT persona_denominacion \n\n" .
        "FROM personas {SQL_Where}\n\n" .
        "GROUP BY persona_denominacion {SQL_OrderBy}";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "planchetas_planchetas_buscar_dominio_PTAutocomplete1.html";
$BlockToParse = "main";
