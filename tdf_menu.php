...
class clsMenutdf_menuMenu1 extends clsMenu { //Menu1 class @42-25BB2247

//Class_Initialize Event @42-C3198099
...
//SetControlValues Method @42-BD219D14
    function SetControlValues() {
        $this->ItemLink->SetValue($this->DataSource->ItemLink->GetValue());
        $this->ItemLink->Page = $this->DataSource->f("menu_link");
        $this->Attributes->SetValue("Target", "_self");
        $this->Attributes->SetValue("Title", $this->DataSource->f("menu_descripcion"));
    }
//End SetControlValues Method

//SetParameters Method @42-B9C797A4
    function SetParameters() {
        $this->DataSource->Parameters["expr48"] = 1;
    }
//End SetParameters Method

//ShowAttributes @42-B1FBE821
...
class clstdf_menuMenu1DataSource extends clsDBtdf_nuevo {  //Menu1DataSource Class @42-79D852AB
...
//DataSourceClass_Initialize Event @42-621CF4D6
...
//SetOrder Method @42-DFB3A165
    function SetOrder($SorterName, $SorterDirection)
    {
        $this->Order = "menu_parent_id, menu_orden, menu_title, menu_id";
        $this->Order = CCGetOrder($this->Order, $SorterName, $SorterDirection, 
            "");
    }
//End SetOrder Method

//Prepare Method @42-B5F0CB8D
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->wp = new clsSQLParameters($this->ErrorBlock);
        $this->wp->AddParameter("1", "expr48", ccsInteger, "", "", $this->Parameters["expr48"], "", true);
        $this->wp->Criterion[1] = $this->wp->Operation(opEqual, "menu_visible_id", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsInteger),true);
        $this->Where = 
             $this->wp->Criterion[1];
    }
//End Prepare Method
...
//BindEvents Method @1-8761C9D3
    function BindEvents()
    {
        $this->Menu1->CCSEvents["BeforeShowRow"] = "tdf_menu_Menu1_BeforeShowRow";
        $this->Menu1->CCSEvents["BeforeShow"] = "tdf_menu_Menu1_BeforeShow";
...
//Initialize Method @1-4BC25681
    function Initialize()
    {
        global $FileName;
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->CCSEvents["BeforeInitialize"] = "tdf_menu_BeforeInitialize";
