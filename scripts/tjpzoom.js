...
function zoom_on(evt,ow,oh,lowres,highres) {
 ...
 '<div style="text-align:left;position:absolute; z-index:2;float:left; '+tooltipstyle+'" id="'+thisid+'_tooltip"><font color="#000000"><b>Cargando...</b></font></div>'+
