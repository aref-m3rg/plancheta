<?php
/**
 * Resuelve el path local de un archivo adjunto a plano (solo basename, ya validado).
 *
 * @param string $archivoParam nombre de archivo (sin rutas)
 * @return string|false ruta absoluta legible o false
 */
function plano_adjunto_archivo_local_path_validated($archivoParam) {
	if (!defined('PLANOS_ATTACHED_FILESYSTEM_ROOT')) {
		return false;
	}
	$baseDir = rtrim(PLANOS_ATTACHED_FILESYSTEM_ROOT, "/\\");
