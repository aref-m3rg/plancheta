<?php
//Include Common Files @1-E9F9C3FB
define("RelativePath", "..");
define("PathToCurrentPage", "/previsado/");
define("FileName", "previsados_nomenclatura_origen.php");
...
//Class_Initialize Event @6-E18202C9
    function clsGridprevisados_parcelas_orige($RelativePath, & $Parent)
    {
        ...
        $this->tipo_depto_parc_desc->Page = "previsados_nomenclatura_origen.php";
...
//DataSource Variables @6-564C4DC3
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @6-D050DA07
...
//Prepare Method @6-9C44DB5E
    function Prepare()
    {
        ...
        $this->wp->Criterion[1] = $this->wp->Operation(opEqual, "previsados_parcelas_origenes.previsado_carga_id", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsInteger),false);
        $this->Where = 
             $this->wp->Criterion[1];
    }
//End Prepare Method

//Open Method @6-D96BFFA1
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*)\n\n" .
        "FROM (previsados_parcelas_origenes LEFT JOIN tipos_deptos_parcela ON\n\n" .
        "previsados_parcelas_origenes.tipo_depto_parc_id = tipos_deptos_parcela.tipo_depto_parc_id) LEFT JOIN parcelas ON\n\n" .
        "previsados_parcelas_origenes.parcela_id = parcelas.parcela_id";
        $this->SQL = "SELECT previsados_parcelas_origenes.*, tipo_depto_parc_abrev, parcela_partida, tipo_depto_parc_desc \n\n" .
        "FROM (previsados_parcelas_origenes LEFT JOIN tipos_deptos_parcela ON\n\n" .
        "previsados_parcelas_origenes.tipo_depto_parc_id = tipos_deptos_parcela.tipo_depto_parc_id) LEFT JOIN parcelas ON\n\n" .
        "previsados_parcelas_origenes.parcela_id = parcelas.parcela_id {SQL_Where} {SQL_OrderBy}";
...
//Class_Initialize Event @35-5DD2341E
...
"GROUP BY parcela_seccion {SQL_OrderBy}";
            ...
            $this->previsados_parcelas_orige_Insert->Page = "previsados_nomenclatura_origen.php";
...
//CheckErrors Method @35-66116B78
...
//DataSource Variables @35-EA853ECD
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @35-336C1800
...
//Open Method @35-DBF6A124
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "SELECT * \n\n" .
        "FROM previsados_parcelas_origenes {SQL_Where} {SQL_OrderBy}";
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeExecuteSelect", $this->Parent);
        $this->PageSize = 1;
        $this->query($this->OptimizeSQL(CCBuildSQL($this->SQL, $this->Where, $this->Order)));
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "AfterExecuteSelect", $this->Parent);
...
//Insert Method @35-1A1E55A5
    function Insert()
    {
        ...
        $this->SQL = CCBuildInsert("previsados_parcelas_origenes", $this->InsertFields, $this);
...
//Update Method @35-993CA31E
    function Update()
    {
        ...
        $this->SQL = CCBuildUpdate("previsados_parcelas_origenes", $this->UpdateFields, $this);
...
//Delete Method @35-9FC89772
    function Delete()
    {
        ...
        $this->SQL = "DELETE FROM previsados_parcelas_origenes";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "previsados_nomenclatura_origen.html";
$BlockToParse = "main";
...
//Include events file @1-47C201B3
include_once("./previsados_nomenclatura_origen_events.php");
