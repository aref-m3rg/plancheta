<?php
//Include Common Files @1-0786D2FE
define("RelativePath", "..");
define("PathToCurrentPage", "/previsado/");
define("FileName", "previsados_nomenclatura_destino.php");
...
//Variables @6-FDE7EE6F
    ...
    public $Sorter_sup_uf;
//End Variables

//Class_Initialize Event @6-4C4C32DA
    function clsGridprevisados_parcelas_orige($RelativePath, & $Parent)
    {
        ...
        $this->tipo_depto_parc_desc->Page = "previsados_nomenclatura_destino.php";
        ...
        $this->unidades_medidas_abrev = new clsControl(ccsLabel, "unidades_medidas_abrev", "unidades_medidas_abrev", ccsText, "", CCGetRequestParam("unidades_medidas_abrev", ccsGet, NULL), $this);
        $this->parcela_super_uf = new clsControl(ccsLabel, "parcela_super_uf", "parcela_super_uf", ccsFloat, array(False, 2, Null, "", False, "", "", 1, True, ""), CCGetRequestParam("parcela_super_uf", ccsGet, NULL), $this);
        $this->unidades_medidas_uf_unidades_medidas_abrev = new clsControl(ccsLabel, "unidades_medidas_uf_unidades_medidas_abrev", "unidades_medidas_uf_unidades_medidas_abrev", ccsText, "", CCGetRequestParam("unidades_medidas_uf_unidades_medidas_abrev", ccsGet, NULL), $this);
        ...
        $this->Sorter_sup_uf = new clsSorter($this->ComponentName, "Sorter_sup_uf", $FileName, $this);
    }
...
//Show Method @6-12B105FF
    function Show()
    {
        ...
        if (!$this->IsEmpty) {
            ...
            $this->ControlsVisible["parcela_super_uf"] = $this->parcela_super_uf->Visible;
            $this->ControlsVisible["unidades_medidas_uf_unidades_medidas_abrev"] = $this->unidades_medidas_uf_unidades_medidas_abrev->Visible;
            ...
            while ($this->ForceIteration || (($this->RowNumber < $this->PageSize) &&  ($this->HasRecord = $this->DataSource->has_next_record()))) {
                ...
                $this->tipo_depto_parc_desc->Parameters = CCAddParam($this->tipo_depto_parc_desc->Parameters, "previsado_parcela_destino_id", $this->DataSource->f("previsado_parcela_destino_id"));
                ...
                $this->unidades_medidas_uf_unidades_medidas_abrev->SetValue($this->DataSource->unidades_medidas_uf_unidades_medidas_abrev->GetValue());
                ...
                $this->unidades_medidas_uf_unidades_medidas_abrev->Show();
                $this->destino->Show();
                $Tpl->block_path = $ParentPath . "/" . $GridBlock;
                $Tpl->parse("Row", true);
            }
...
//GetErrors Method @6-19156DE0
    function GetErrors()
    {
        ...
        $errors = ComposeStrings($errors, $this->parcela_super_uf->Errors->ToString());
        $errors = ComposeStrings($errors, $this->unidades_medidas_uf_unidades_medidas_abrev->Errors->ToString());
...
//DataSource Variables @6-E3E5743A
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
    ...
    public $unidades_medidas_uf_unidades_medidas_abrev;
    public $destino;
//End DataSource Variables

//DataSourceClass_Initialize Event @6-D5AA25DB
    function clsprevisados_parcelas_origeDataSource(& $Parent)
    {
        ...
        $this->unidades_medidas_uf_unidades_medidas_abrev = new clsField("unidades_medidas_uf_unidades_medidas_abrev", ccsText, "");
...
//SetOrder Method @6-92CD7BEF
    function SetOrder($SorterName, $SorterDirection)
    {
        $this->Order = "previsados_parcelas_destinos.previsado_parcela_destino_id";
        $this->Order = CCGetOrder($this->Order, $SorterName, $SorterDirection, 
            ...
            "Sorter_parcela_super_mensura" => array("parcelas.parcela_super_mensura", ""), 
            "Sorter_sup_uf" => array("parcela_super_uf", "")));
    }
//End SetOrder Method

//Prepare Method @6-D169AA2A
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        ...
        $this->wp->Criterion[1] = $this->wp->Operation(opEqual, "previsados_parcelas_destinos.previsado_carga_id", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsInteger),false);
        $this->Where = 
             $this->wp->Criterion[1];
    }
//End Prepare Method

//Open Method @6-B66DDCB6
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*)\n\n" .
        "FROM ((((previsados_parcelas_destinos LEFT JOIN parcelas ON\n\n" .
        "previsados_parcelas_destinos.parcela_id = parcelas.parcela_id) LEFT JOIN tipos_deptos_parcela ON\n\n" .
        "previsados_parcelas_destinos.tipo_depto_parc_id = tipos_deptos_parcela.tipo_depto_parc_id) LEFT JOIN unidades_medidas ON\n\n" .
        "previsados_parcelas_destinos.unidades_medidas_id = unidades_medidas.unidades_medidas_id) LEFT JOIN unidades_medidas unidades_medidas_uf ON\n\n" .
        "previsados_parcelas_destinos.unidades_medidas_uf_id = unidades_medidas_uf.unidades_medidas_id) LEFT JOIN previsados_titulares_fijos ON\n\n" .
        "previsados_parcelas_destinos.previsado_titular_fijo_id = previsados_titulares_fijos.previsado_titular_fijo_id";
        $this->SQL = "SELECT parcela_nomenclatura, previsados_parcelas_destinos.*, tipo_depto_parc_desc, tipo_depto_parc_abrev, parcela_partida, unidades_medidas.unidades_medidas_abrev AS unidades_medidas_unidades_medidas_abrev,\n\n" .
        "unidades_medidas_uf.unidades_medidas_descrip AS unidades_medidas_uf_unidades_medidas_descrip, unidades_medidas_uf.unidades_medidas_abrev AS unidades_medidas_uf_unidades_medidas_abrev,\n\n" .
        "unidades_medidas_uf.unidades_medidas_htm AS unidades_medidas_uf_unidades_medidas_htm, previsado_titular_fijo_nombre \n\n" .
        "FROM ((((previsados_parcelas_destinos LEFT JOIN parcelas ON\n\n" .
        "previsados_parcelas_destinos.parcela_id = parcelas.parcela_id) LEFT JOIN tipos_deptos_parcela ON\n\n" .
        "previsados_parcelas_destinos.tipo_depto_parc_id = tipos_deptos_parcela.tipo_depto_parc_id) LEFT JOIN unidades_medidas ON\n\n" .
        "previsados_parcelas_destinos.unidades_medidas_id = unidades_medidas.unidades_medidas_id) LEFT JOIN unidades_medidas unidades_medidas_uf ON\n\n" .
        "previsados_parcelas_destinos.unidades_medidas_uf_id = unidades_medidas_uf.unidades_medidas_id) LEFT JOIN previsados_titulares_fijos ON\n\n" .
        "previsados_parcelas_destinos.previsado_titular_fijo_id = previsados_titulares_fijos.previsado_titular_fijo_id {SQL_Where} {SQL_OrderBy}";
...
//SetValues Method @6-37F0315B
    function SetValues()
    {
        ...
        $this->unidades_medidas_abrev->SetDBValue($this->f("unidades_medidas_unidades_medidas_abrev"));
        $this->parcela_super_uf->SetDBValue(trim($this->f("parcela_super_uf")));
        $this->unidades_medidas_uf_unidades_medidas_abrev->SetDBValue($this->f("unidades_medidas_uf_unidades_medidas_abrev"));
        $this->destino->SetDBValue($this->f("previsado_titular_fijo_nombre"));
    }
//End SetValues Method

} //End previsados_parcelas_origeDataSource Class @6-FCB6E20C

class clsRecordprevisados_parcelas_dest1 { //previsados_parcelas_dest1 Class @35-EBA008F0
...
//Class_Initialize Event @35-A938DE32
    function clsRecordprevisados_parcelas_dest1($RelativePath, & $Parent)
    {
        ...
        $this->RelativePath = $RelativePath;
        $this->Errors = new clsErrors();
        $this->ErrorBlock = "Record previsados_parcelas_dest1/Error";
        $this->DataSource = new clsprevisados_parcelas_dest1DataSource($this);
        $this->ds = & $this->DataSource;
        ...
        if($this->Visible)
        {
            $this->ComponentName = "previsados_parcelas_dest1";
            $this->Attributes = new clsAttributes($this->ComponentName . ":");
...
"GROUP BY parcela_seccion {SQL_OrderBy}";
            ...
            $this->previsados_parcelas_orige_Insert->Parameters = CCGetQueryString("QueryString", array("previsado_parcela_destino_id", "previsados_parcelas_origeOrder", "previsados_parcelas_origeDir", "ccsForm"));
            $this->previsados_parcelas_orige_Insert->Page = "previsados_nomenclatura_destino.php";
            ...
            $this->parcela_super_mensura = new clsControl(ccsTextBox, "parcela_super_mensura", "Superficie", ccsFloat, "", CCGetRequestParam("parcela_super_mensura", $Method, NULL), $this);
            $this->parcela_super_uf = new clsControl(ccsTextBox, "parcela_super_uf", "parcela_super_uf", ccsFloat, "", CCGetRequestParam("parcela_super_uf", $Method, NULL), $this);
...
"FROM unidades_medidas {SQL_Where} {SQL_OrderBy}";
            $this->unidades_medidas_id->DataSource->Order = "unidades_medidas_id";
            ...
            $this->unidades_medidas_id->DataSource->Order = "unidades_medidas_id";
            $this->unidades_medidas_uf_id = new clsControl(ccsListBox, "unidades_medidas_uf_id", "unidades_medidas_uf_id", ccsInteger, "", CCGetRequestParam("unidades_medidas_uf_id", $Method, NULL), $this);
...
"FROM unidades_medidas {SQL_Where} {SQL_OrderBy}";
            $this->unidades_medidas_uf_id->DataSource->Order = "unidades_medidas_id";
            ...
            $this->unidades_medidas_uf_id->DataSource->Order = "unidades_medidas_id";
            $this->Button_adds = new clsButton("Button_adds", $Method, $this);
            $this->Button_deletes = new clsButton("Button_deletes", $Method, $this);
            $this->cant_destino = new clsControl(ccsHidden, "cant_destino", "cant_destino", ccsText, "", CCGetRequestParam("cant_destino", $Method, NULL), $this);
            $this->rango_tipo = new clsControl(ccsListBox, "rango_tipo", "rango_tipo", ccsText, "", CCGetRequestParam("rango_tipo", $Method, NULL), $this);
            $this->rango_tipo->DSType = dsListOfValues;
            $this->rango_tipo->Values = array(array("1", "Parcelas"), array("2", "UF|UC"));
            $this->ini = new clsControl(ccsTextBox, "ini", "ini", ccsText, "", CCGetRequestParam("ini", $Method, NULL), $this);
            $this->fin = new clsControl(ccsTextBox, "fin", "fin", ccsText, "", CCGetRequestParam("fin", $Method, NULL), $this);
            $this->previsado_titular_fijo_id = new clsControl(ccsListBox, "previsado_titular_fijo_id", "previsado_titular_fijo_id", ccsText, "", CCGetRequestParam("previsado_titular_fijo_id", $Method, NULL), $this);
            $this->previsado_titular_fijo_id->DSType = dsTable;
            $this->previsado_titular_fijo_id->DataSource = new clsDBtdf_nuevo();
            $this->previsado_titular_fijo_id->ds = & $this->previsado_titular_fijo_id->DataSource;
            $this->previsado_titular_fijo_id->DataSource->SQL = "SELECT * \n" .
"FROM previsados_titulares_fijos {SQL_Where} {SQL_OrderBy}";
            list($this->previsado_titular_fijo_id->BoundColumn, $this->previsado_titular_fijo_id->TextColumn, $this->previsado_titular_fijo_id->DBFormat) = array("previsado_titular_fijo_id", "previsado_titular_fijo_nombre", "");
            $this->previsado_titular_fijo_id1 = new clsControl(ccsListBox, "previsado_titular_fijo_id1", "previsado_titular_fijo_id1", ccsInteger, "", CCGetRequestParam("previsado_titular_fijo_id1", $Method, NULL), $this);
            $this->previsado_titular_fijo_id1->DSType = dsTable;
            $this->previsado_titular_fijo_id1->DataSource = new clsDBtdf_nuevo();
            $this->previsado_titular_fijo_id1->ds = & $this->previsado_titular_fijo_id1->DataSource;
            $this->previsado_titular_fijo_id1->DataSource->SQL = "SELECT * \n" .
"FROM previsados_titulares_fijos {SQL_Where} {SQL_OrderBy}";
            list($this->previsado_titular_fijo_id1->BoundColumn, $this->previsado_titular_fijo_id1->TextColumn, $this->previsado_titular_fijo_id1->DBFormat) = array("previsado_titular_fijo_id", "previsado_titular_fijo_nombre", "");
            if(!$this->FormSubmitted) {
                if(!is_array($this->parcela_super_mensura->Value) && !strlen($this->parcela_super_mensura->Value) && $this->parcela_super_mensura->Value !== false)
                    $this->parcela_super_mensura->SetText(0.0);
                if(!is_array($this->parcela_super_uf->Value) && !strlen($this->parcela_super_uf->Value) && $this->parcela_super_uf->Value !== false)
                    $this->parcela_super_uf->SetText(0.0);
            }
        }
    }
//End Class_Initialize Event

//Initialize Method @35-022B04ED
    function Initialize()
    {
...
//Validate Method @35-38B92901
    function Validate()
    {
        ...
        $Validation = ($this->cant_destino->Validate() && $Validation);
        $Validation = ($this->rango_tipo->Validate() && $Validation);
        $Validation = ($this->ini->Validate() && $Validation);
        $Validation = ($this->fin->Validate() && $Validation);
        $Validation = ($this->previsado_titular_fijo_id->Validate() && $Validation);
        $Validation = ($this->previsado_titular_fijo_id1->Validate() && $Validation);
        ...
        $Validation =  $Validation && ($this->cant_destino->Errors->Count() == 0);
        $Validation =  $Validation && ($this->rango_tipo->Errors->Count() == 0);
        $Validation =  $Validation && ($this->ini->Errors->Count() == 0);
        $Validation =  $Validation && ($this->fin->Errors->Count() == 0);
        $Validation =  $Validation && ($this->previsado_titular_fijo_id->Errors->Count() == 0);
        $Validation =  $Validation && ($this->previsado_titular_fijo_id1->Errors->Count() == 0);
        return (($this->Errors->Count() == 0) && $Validation);
    }
//End Validate Method

//CheckErrors Method @35-F1D00574
    function CheckErrors()
    {
        ...
        $errors = ($errors || $this->cant_destino->Errors->Count());
        $errors = ($errors || $this->rango_tipo->Errors->Count());
        $errors = ($errors || $this->ini->Errors->Count());
        $errors = ($errors || $this->fin->Errors->Count());
        $errors = ($errors || $this->previsado_titular_fijo_id->Errors->Count());
        $errors = ($errors || $this->previsado_titular_fijo_id1->Errors->Count());
...
//Operation Method @35-66EDFC3A
    function Operation()
    {
        ...
        if($this->FormSubmitted) {
            ...
            } else if($this->Button_adds->Pressed) {
                $this->PressedButton = "Button_adds";
            } else if($this->Button_deletes->Pressed) {
                $this->PressedButton = "Button_deletes";
            }
        }
        ...
        if($this->PressedButton == "Button_Delete") {
            ...
            $Redirect = "previsados_cargas.php" . "?" . CCGetQueryString("QueryString", array("ccsForm", "previsado_parcela_destino_id"));
            if(!CCGetEvent($this->Button_Cancel->CCSEvents, "OnClick", $this->Button_Cancel)) {
                $Redirect = "";
            }
        } else if($this->PressedButton == "Button_adds") {
            if(!CCGetEvent($this->Button_adds->CCSEvents, "OnClick", $this->Button_adds)) {
                $Redirect = "";
            }
        } else if($this->PressedButton == "Button_deletes") {
            if(!CCGetEvent($this->Button_deletes->CCSEvents, "OnClick", $this->Button_deletes)) {
                $Redirect = "";
            }
...
//InsertRow Method @35-D07F1F59
    function InsertRow()
    {
        ...
        $this->DataSource->cant_destino->SetValue($this->cant_destino->GetValue(true));
        $this->DataSource->rango_tipo->SetValue($this->rango_tipo->GetValue(true));
        $this->DataSource->ini->SetValue($this->ini->GetValue(true));
        $this->DataSource->fin->SetValue($this->fin->GetValue(true));
        $this->DataSource->previsado_titular_fijo_id->SetValue($this->previsado_titular_fijo_id->GetValue(true));
        $this->DataSource->previsado_titular_fijo_id1->SetValue($this->previsado_titular_fijo_id1->GetValue(true));
...
//Show Method @35-DEF1C0BF
    function Show()
    {
        ...
        $this->rango_tipo->Prepare();
        $this->previsado_titular_fijo_id->Prepare();
        $this->previsado_titular_fijo_id1->Prepare();
        ...
        if($this->EditMode) {
            ...
            if($this->DataSource->Errors->Count() == 0 && $this->DataSource->next_record()) {
                ...
                if(!$this->FormSubmitted){
                    ...
                    $this->previsado_titular_fijo_id1->SetValue($this->DataSource->previsado_titular_fijo_id1->GetValue());
                }
            } else {
                $this->EditMode = false;
            }
        ...
        if($this->FormSubmitted || $this->CheckErrors()) {
            ...
            $Error = ComposeStrings($Error, $this->cant_destino->Errors->ToString());
            $Error = ComposeStrings($Error, $this->rango_tipo->Errors->ToString());
            $Error = ComposeStrings($Error, $this->ini->Errors->ToString());
            $Error = ComposeStrings($Error, $this->fin->Errors->ToString());
            $Error = ComposeStrings($Error, $this->previsado_titular_fijo_id->Errors->ToString());
            $Error = ComposeStrings($Error, $this->previsado_titular_fijo_id1->Errors->ToString());
        ...
        $this->Button_adds->Show();
        $this->Button_deletes->Show();
        $this->cant_destino->Show();
        $this->rango_tipo->Show();
        $this->ini->Show();
        $this->fin->Show();
        $this->previsado_titular_fijo_id->Show();
        $this->previsado_titular_fijo_id1->Show();
        $Tpl->parse();
        $Tpl->block_path = $ParentPath;
        $this->DataSource->close();
    }
...
} //End previsados_parcelas_dest1 Class @35-FCB6E20C

class clsprevisados_parcelas_dest1DataSource extends clsDBtdf_nuevo {  //previsados_parcelas_dest1DataSource Class @35-E7907C09

//DataSource Variables @35-F1B512E2
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
    ...
    public $ini;
    public $fin;
    public $previsado_titular_fijo_id;
    public $previsado_titular_fijo_id1;
//End DataSource Variables

//DataSourceClass_Initialize Event @35-1A0E3209
    function clsprevisados_parcelas_dest1DataSource(& $Parent)
    {
        $this->Parent = & $Parent;
        $this->ErrorBlock = "Record previsados_parcelas_dest1/Error";
        $this->Initialize();
        ...
        $this->cant_destino = new clsField("cant_destino", ccsText, "");
        
        $this->rango_tipo = new clsField("rango_tipo", ccsText, "");
        
        $this->ini = new clsField("ini", ccsText, "");
        
        $this->fin = new clsField("fin", ccsText, "");
        
        $this->previsado_titular_fijo_id = new clsField("previsado_titular_fijo_id", ccsText, "");
        
        $this->previsado_titular_fijo_id1 = new clsField("previsado_titular_fijo_id1", ccsInteger, "");
        ...
        $this->InsertFields["parcela_super_uf"] = array("Name" => "parcela_super_uf", "Value" => "", "DataType" => ccsFloat, "OmitIfEmpty" => 1);
        $this->InsertFields["unidades_medidas_id"] = array("Name" => "unidades_medidas_id", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        $this->InsertFields["unidades_medidas_uf_id"] = array("Name" => "unidades_medidas_uf_id", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        $this->InsertFields["previsado_titular_fijo_id"] = array("Name" => "previsado_titular_fijo_id", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        ...
        $this->UpdateFields["previsado_titular_fijo_id"] = array("Name" => "previsado_titular_fijo_id", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
    }
//End DataSourceClass_Initialize Event

//Prepare Method @35-F29F1EFE
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
...
//SetValues Method @35-2A326AFD
    function SetValues()
    {
        ...
        $this->previsado_titular_fijo_id1->SetDBValue(trim($this->f("previsado_titular_fijo_id")));
    }
//End SetValues Method

//Insert Method @35-71E855FE
    function Insert()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        ...
        $this->InsertFields["parcela_super_uf"]["Value"] = $this->parcela_super_uf->GetDBValue(true);
        $this->InsertFields["unidades_medidas_id"]["Value"] = $this->unidades_medidas_id->GetDBValue(true);
        $this->InsertFields["unidades_medidas_uf_id"]["Value"] = $this->unidades_medidas_uf_id->GetDBValue(true);
        $this->InsertFields["previsado_titular_fijo_id"]["Value"] = $this->previsado_titular_fijo_id1->GetDBValue(true);
        $this->SQL = CCBuildInsert("previsados_parcelas_destinos", $this->InsertFields, $this);
...
//Update Method @35-5F6D996B
    function Update()
    {
        ...
        $this->UpdateFields["previsado_titular_fijo_id"]["Value"] = $this->previsado_titular_fijo_id1->GetDBValue(true);
...
//Delete Method @35-32A93F80
    function Delete()
    {
        ...
        $this->SQL = "DELETE FROM previsados_parcelas_destinos";
...
} //End previsados_parcelas_dest1DataSource Class @35-FCB6E20C

//Initialize Page @1-769C0679
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "previsados_nomenclatura_destino.html";
$BlockToParse = "main";
...
//Include events file @1-F69A28F1
include_once("./previsados_nomenclatura_destino_events.php");
...
$previsados_parcelas_dest1 = new clsRecordprevisados_parcelas_dest1("", $MainPage);
$MainPage->tdf_header = & $tdf_header;
$MainPage->tdf_footer = & $tdf_footer;
$MainPage->previsados_parcelas_orige = & $previsados_parcelas_orige;
$MainPage->previsados_parcelas_dest1 = & $previsados_parcelas_dest1;
$previsados_parcelas_orige->Initialize();
$previsados_parcelas_dest1->Initialize();
...
//Execute Components @1-ECEF0497
$tdf_header->Operations();
$tdf_footer->Operations();
$previsados_parcelas_dest1->Operation();
//End Execute Components

//Go to destination page @1-3D2AFBD0
if($Redirect)
{
    ...
    unset($previsados_parcelas_dest1);
    unset($Tpl);
    exit;
}
//End Go to destination page

//Show Page @1-CB2B70E1
$tdf_header->Show();
$tdf_footer->Show();
$previsados_parcelas_orige->Show();
$previsados_parcelas_dest1->Show();
$Tpl->block_path = "";
$Tpl->Parse($BlockToParse, false);
if (!isset($main_block)) $main_block = $Tpl->GetVar($BlockToParse);
if(preg_match("/<\/body>/i", $main_block)) {
    $main_block = preg_replace("/<\/body>/i", "<center><font face=\"Arial\"><small>Ge&#110;erat&" . "#101;d <!-- CCS -->w&#105;&#116;h <!-- SCC " . "-->C&#111;&#100;eC&#104;&#97;r&#103;e <!-- CCS -" . "->&#83;&#116;u&#100;io.</small></font></center>" . "" . "</body>", $main_block);
} else if(preg_match("/<\/html>/i", $main_block) && !preg_match("/<\/frameset>/i", $main_block)) {
    $main_block = preg_replace("/<\/html>/i", "<center><font face=\"Arial\"><small>Ge&#110;erat&" . "#101;d <!-- CCS -->w&#105;&#116;h <!-- SCC " . "-->C&#111;&#100;eC&#104;&#97;r&#103;e <!-- CCS -" . "->&#83;&#116;u&#100;io.</small></font></center>" . "" . "</html>", $main_block);
} else if(!preg_match("/<\/frameset>/i", $main_block)) {
    $main_block .= "<center><font face=\"Arial\"><small>Ge&#110;erat&" . "#101;d <!-- CCS -->w&#105;&#116;h <!-- SCC " . "-->C&#111;&#100;eC&#104;&#97;r&#103;e <!-- CCS -" . "->&#83;&#116;u&#100;io.</small></font></center>" . "";
}
$CCSEventResult = CCGetEvent($CCSEvents, "BeforeOutput", $MainPage);
if ($CCSEventResult) echo $main_block;
//End Show Page

//Unload Page @1-9A253A1A
$CCSEventResult = CCGetEvent($CCSEvents, "BeforeUnload", $MainPage);
$DBtdf_nuevo->close();
$tdf_header->Class_Terminate();
unset($tdf_header);
